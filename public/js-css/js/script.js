...
function menu_close(){
  var key = document.getElementById('close-menu').textContent;
  if(key == 1){

    document.getElementById('close-menu').innerHTML= "0";
    var menu = document.getElementsByClassName('sidenav')[0];
    var camera = document.getElementsByClassName('content-camera')[0];
    ...
    document.getElementById('close-menu').innerHTML= "1";
    var menu = document.getElementsByClassName('sidenav')[0];
    var camera = document.getElementsByClassName('content-camera')[0];
  ...
  setTimeout(() => {  document.getElementById("refButton").click(); }, 300)
