...
<div class="content-camera">
  ...
  <div class="row-content">
      ...
      <li class="nav-item margin_center">
          ...
          data-toggle="tab" role="tab" href="#content1">Quản lý dự án {{$total_job->name}}</a>
      </li>
...
<a href="/building/list" class="btn btn-model">Quay lại</a>

      <button type="button" class="btn btn-model  btn-lg"  onclick="ToggleNext(this)">Bộ lọc</button>
...
@if($lid->root_id == 0  && ($cache == "null" || $cache == "none" || strpos($cache,strval($lid->id)) > -1))
// setTimeout(loadIframe, 7000,{{$lid->id}});
 loadIframe({{$lid->id}})
