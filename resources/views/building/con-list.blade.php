                        ...
                        <tbody class="tbody">
                          @foreach($building_list as $building)
                            <tr class="color-add">
    	                        ...
    	                        <td><i id="project{{$building->id}}" class="fa fa-circle active-off cam-status" aria-hidden="true"></i> <img src="js-css/img/icon/map.png" width='32' height='32'><a href="/chatify/build/{{$building->id}}"> {{$building->name}}</a></td>
                              </tr>
                          @endforeach
                        </tbody>
                      </table>
