  ...
  width: 80%;
    ...
    <div class="row row-content">
      ...
      <li class="nav-item margin_center">
          ...
          data-toggle="tab" role="tab" href="#content1">{{$total_file->name}}</a>
      </li>    
    </ul> 

    @if($total_file->type == 0)
      <a type="button" class="btn btn-model" href="/building/warehouse/{{$root_id}}">Quay lại</a>
      @else
      <a type="button" class="btn btn-model" href="/building/warehouse-job/{{$root_id}}" >Quay lại</a>
...
<br><br>
          <div id="content1" class=" container tab-pane  in active">
            ...
            <li>
              ...
              <!-- <a href="building/warehouse/file-delete-by-id/{{$id}}/{{$file->id}}"><img src="/js-css/img/icon/recycle_bin.png"></a> -->
              <button class="btn btn-del Disable preview" onclick="confirm_remove(this,{{$file->id}})">
          ...
          <div class="modal-dialog model-right" style="width: 50%;height:2000px">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
               <form id="uploadfile" action="building/warehouse/add-task-file"  enctype="multipart/form-data" method="POST">
...
<script type="text/javascript">
        ...
        function confirm_remove(ele,id) {
              ...
              swal({ 
                  ...
                  {   
                    loading_nomal()
                    location.href="building/warehouse/file-delete-by-id/{{$id}}/"+id
                    swal.close(); 
                  } 
                  else {     
                    swal.close();  
