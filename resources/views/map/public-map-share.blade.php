...
background-color: rgba(255, 102, 153, 5.9);
  border-radius: 50%;
  font-size: 15px;
  font-weight: 30px;
  display: block;
...
<ul class="nav nav-tabs" id="tabs" role="tablist">
      <li class="nav-item margin_center">
          <a id="tab1" class="nav-link active color-a"  data-toggle="tab" role="tab" href="#content1"  onclick='$(".myInitPopupinfo").show();'>Bản đồ dự án</a>
      </li> 
      <li class="nav-item margin_center">
          <a id="tab0" class="nav-link color-a"  data-toggle="tab" role="tab" href="#content0"  onclick='$(".myInitPopupinfo").hide();'>Bản đồ địa giới</a>
      </li>
...
<div class="myInitPopupinfo" style="" onclick='$(".myInitPopupinfo").hide();'>
      <div class="modal-body" id="initPopupdetail" style="color:white;">
      </div>
</div>
...
cell2.innerHTML = "<span id='zone" +data.id +"acreage'>"+data.acreage+" m <sup>2</sup></span>"
}else{
cell2.innerHTML = "<span id='zone" +data.id +"acreage'> Trống </span>"
 ...
 pology = pology + '<g><polygon id="pzone'+data.id+'" points="'+zone.toString()+'" style="fill: rgba(0, 0, 0, 0.3);"></polygon></g>';
   ...
   if({{$zid}} == data.id){
pology = pology + '<g><polygon id="pzone'+data.id+'" points="'+zone.toString()+'" style="fill: rgba(255, 0, 255, 0.4);"></polygon></g>'

console.log(zone)
console.log(zone[0])
      var offset = $("#zone").offset();
     if (window.innerWidth >  800){
  $(".myInitPopupinfo").css({left:offset.left +  zone[0]+50});
  $(".myInitPopupinfo").css({top: offset.top + zone[1]+50});
}else if (window.innerWidth >  600){
  $(".myInitPopupinfo").css({left:offset.left +  zone[0]+20});
  $(".myInitPopupinfo").css({top: offset.top + zone[1]+20});

}else{

  $(".myInitPopupinfo").css({left:offset.left +  zone[0]+15});
  $(".myInitPopupinfo").css({top: offset.top + zone[1]+15});
}
var html = data.name +  "("+data.acreage+" m <sup>2</sup>)"
console.log(html)
        $("#initPopupdetail").html(html)
}
...
if({{$zid}} == myLastId){
        ...
        document.getElementById("pzone"+myLastId).style.fill = "rgba(255, 0, 255, 0.4)";
