                  ...
                  <table id="camera-table" class="nvr-table">
                        ...
                        <tbody class="tbody">
                          @foreach($projects as $project)
                            <tr class="color-add">
    	                        @if($project->display   == 0)
    	                        <td><i id="project{{$project->ip}}" class="fa fa-circle active-off cam-status" aria-hidden="true"></i> <img src="js-css/img/icon/map.png" width='32' height='32'><a href="/area-full-list/{{$project->id}}"> {{$project->name}}</a></td>
                              @else
                              <td><i id="project{{$project->ip}}" class="fa fa-circle active-off cam-status" aria-hidden="true"></i> <img src="js-css/img/icon/map.png" width='32' height='32'><a href="/mini-list/{{$project->id}}"> {{$project->name}}</a></td>

                              @endif
                            
                              <td><button class="preview" type="button"><img src="/js-css/img/icon/play.png"></button><img class="img-popup" hidden="" src="/js-css/img/project/{{$project->url}}"></td>
