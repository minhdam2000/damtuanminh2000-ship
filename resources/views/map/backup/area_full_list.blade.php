...
<?php
      ...
      if(Auth()->user()->admin_id <= 2){
?>
<button id="lockBtn" type="button" class="camera-button" onclick="lockZone()"><i class="fa fa-lock" aria-hidden="true"></i> Khóa</button>



<button id="openBtn" type="button" class="camera-button" onclick="openZone()"><i class="fa fa-unlock" aria-hidden="true"></i> Mở khóa</button>
<?php
}
?>
...
<div class="mapouter"><div class="gmap_canvas"><iframe width="100%" height="945"  id="gmap_canvas" src="https://maps.google.com/maps?q=Su%E1%BB%91i%20N%C6%B0%E1%BB%9Bc%20N%C3%B3ng%20H%E1%BB%99i%20V%C3%A2n%20Ph%C3%B9%20C%C3%A1t%20B%C3%ACnh%20%C4%90%E1%BB%8Bnh&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://123movies-to.org"></a><br><style>.mapouter{position:relative;text-align:right;height:945;width:100%;}</style><a href="https://www.embedgooglemap.net">google iframe</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:945;width:100%;}</style></div></div>
...
<ul style="display:none">
   ...
   <a href="" class="btn btn-model" id="UpdateLinkInfo"> &nbsp;&nbsp; Hoàn thành&nbsp;&nbsp; </a>


   <a href="" class="btn btn-model" id="LockLinkInfo"> &nbsp;&nbsp; Khóa lô&nbsp;&nbsp; </a>

    <a href="" class="btn btn-model" id="DepositLinkInfo"> &nbsp;&nbsp; Đặt cọc thiện chí &nbsp;&nbsp; </a>
