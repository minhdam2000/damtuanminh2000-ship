...
cell2.innerHTML = "<span id='zone" +data.id +"acreage'> Trống </span>"
    ...
    cell10.innerHTML = hidden_input + '<i class="fa fa-eye" aria-hidden="true" onclick = "loadDisplayZoneData('+data.id+','+data.state+')"></i>'
      ...
      if (data.lock > 0){
          if (data.lock == 1){
 pology = pology + '<g><polygon points="'+zone.toString()+'" style="fill: rgba(0, 0, 0, 0.3);"></polygon></g>';
          }else{
             pology = pology + '<g><polygon points="'+zone.toString()+'" style="fill: rgba(0, 0, 0, 0.7);"></polygon></g>';
          }
      }
         ...
         <?php
          ...
          ?>
      pology = pology + '<g><polygon points="'+zone.toString()+'" style="fill: rgba(0, 0, 0, 0.1);"></polygon></g>';
      <?php
      } else{
      ?>
      ...
      pology = pology + '<g><polygon points="'+zone.toString()+'" style="fill: rgba(0, 0, 255, 0.2);"></polygon></g>';
      }
      else if (data.state == 2){    
      pology = pology + '<g><polygon points="'+zone.toString()+'" style="fill: rgba(0, 0, 255, 0.2);"></polygon></g>';
      }
      else if (data.state == 3){    
      pology = pology + '<g><polygon points="'+zone.toString()+'" style="fill: rgba(0, 255, 0, 0.2);"></polygon></g>';
      }
      // console.log(pology)
