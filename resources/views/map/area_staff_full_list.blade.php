...
<iframe src="https://www.google.com/maps/d/embed?mid=1u4yDvex1wDcIOFTs-h5a-uhq9XRxmTc&ehbc=2E312F&z=15" width="100%" height="945"></iframe>
          ...
          <ul id = "confirm_info"  class="list-group">
            <li class="list-group-item">  
              <a href="" class="btn btn-model" id="LinkInfo"> &nbsp;&nbsp; Chi tiết &nbsp;&nbsp; </a>  
                 <a href="" target="_blank" class="btn btn-model" style="display:none" id="ShareLink" > &nbsp;&nbsp; Chia sẻ &nbsp;&nbsp; </a>
