...
<td> <a href="/map-config/{{$project->id}}"> <button class="preview" type="button"><img src="/js-css/img/icon/gear.png"></button></a></td>

                             <td> <a href="/mini-fix-list/{{$project->id}}"> <button class="preview" type="button"><img src="/js-css/img/icon/gear2.png"></button></a></td>
