...
<iframe src="https://www.google.com/maps/d/embed?mid=1FaNFj2gdcwYHXGs4lZUSghMBls_LCAI&ehbc=2E312F&z=15" width="100%" height="945"></iframe>
...
document.getElementById("zone_edit_name").value = document.getElementById("zone"+id+"name").innerHTML ;
  ...
  document.getElementById("LinkInfo").href = "/chatify/zone-sale/" + id
