...
@section('content')
    ...
    <div class="row row-content">
      ...
      <li class="nav-item margin_center">
          ...
          data-toggle="tab" role="tab" href="#content1">Hóa đơn cho danh mục {{$tax->name}}</a>
      </li>    
    </ul>  
    <hr>

        <div class="tab-content"> <label  class="preview" for="file-input">
          <a href="/finance/tax" type="button"  class="btn btn-model" > Quay lại</a>
                    ...
                    <tbody class="tbody">
                      @foreach($file as $file)
                        <tr class="color-add">   
                          ...
                          @else
                          <td><span id="name{{$file->id}}">{{$tax->name}}</span> {{$file->image_id}}</td>
                          ...
                          <td class = "center-td">
                            ...
                            <button onclick="loadFile('{{$tax->name."".$file->image_id}}<','{{$file->url}}')" class="preview" type="button"><img src="/js-css/img/icon/open.png"></button>

                               <a href="<?=$file->url?>"  target="_blank" type="button"  class="preview" > <img src="/js-css/img/icon/plus.png"> </a>

                          <a href="finance/file-delete/<?=$file->id?>" type="button"  class="preview" > <img src="/js-css/img/icon/delete.png"> </a></td>
          ...
          <div class="modal-dialog model-right" style="width: 50%">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
               <form id="uploadfile" action="finance/edit-task-file"  enctype="multipart/form-data" method="POST">
                <input type="hidden" name="_token" value="{{csrf_token()}}">  
   ...
   <div class="modal fade modol-text" id="new-edge" role="dialog">
          <div class="modal-dialog model-right" style="width: 50%">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
              <form action="finance/edit-task-file-name" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
                  <div class="modal-body">
                    <table class="table-edit table-model">
                        <tbody class="table-edit">
