...
<hr><br>
                        ...
                        <tbody class="tbody">
                          @foreach($data as $info)
                            <tr class="color-add">
                              ...
                              <td><a id="iname{{$info->id}}"> {{$info->title}}</a></td>
                              <td><a id="ides{{$info->id}}" > {{$info->description}}</a></td>
                              <td>
                              ...
                              <a id="inumdisplay{{$info->id}}"> {{number_format(floatval($info->amount), 0, ",", ".") }}  VND</a></td>
                          ...
                          @endforeach
                           ...
                           @foreach($salary as $info)
                            <tr class="color-add">
                              ...
                              <td><a > Tiền lương {{$info->month}}/{{$info->year}}</a></td>
                              <td><a  > </a></td>
                              
                              <td><a> {{number_format(floatval($info->salary), 0, ",", ".") }}  VND</a></td>
                              @if($info->month < 10)
                              <td><a >{{$info->year}}-0{{$info->month}}-01</a></td>
                             @else
                              <td><a >{{$info->year}}-{{$info->month}}-01</a></td>
       ...
       @foreach($gap as $info)
                            <tr class="color-add">
                              ...
                              <td><a > Tiền hoa hồng {{$info->time_display}}</a></td>
                              <td><a  > </a></td>
                              
                              <td><a> {{number_format(floatval($info->gap), 0, ",", ".") }}  VND</a></td>

                              <td><a >{{$info->time}}-01</a></td>
