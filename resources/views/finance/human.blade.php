...
@section('content')
    <div class="content-camera">
      ...
      <li class="nav-item margin_center">
       ...
       <li class="nav-item margin_center">
          <a id="tab2" class="nav-link color-a" 
          data-toggle="tab" role="tab" href="#content2">Tổng hoa hồng</a>
      </li>
...
<br><hr>
                        ...
                        <tbody class="tbody">
                          @foreach($users_near as $user)
                            <tr class="color-add">
                              ...
                              <td><div><a id="name1{{$user->id}}"> {{$user->name}}</a></td>
                              <td><div><a id="role1{{$user->id}}"> {{$user->rname}}</a></td>
                              <td><div><a id="gap1{{$user->id}}">   @if($user->gap > 0)
                            ...
                            <td><button style="color: white"  type="button" onclick="showInfo('{{$user->id}}')" class="btn btn-del Disable"><i class="fa fa-eye" aria-hidden="true" style="font-size: 1.2rem;"></i></button></td>
          ...
          <div id="content2" class="tab-pane fade">
                ...
                <div class="title-list-proxy"><i class="fa fa-list" aria-hidden="true"></i> &nbsp;</div>
                 ...
                 <br><hr>
                  <table id="table2" class="nvr-table">
                        <thead>
                        <tr class="thead">
                          ...
                          @foreach($users as $user)
                            <tr class="color-add">
                              ...
                              <td><div><a id="name{{$user->id}}"> {{$user->name}}</a></td>
                                <td><div><a id="role{{$user->id}}"> {{$user->rname}}</a></td>

                              <td><div><a id="gap{{$user->id}}">
                                @if($user->gap > 0)
                              {{number_format($user->gap, 0, ",", ".") }} VND
                              @else
                              Không 
