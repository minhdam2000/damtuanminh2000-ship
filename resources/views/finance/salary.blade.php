...
@section('content')
    ...
    <hr>
        ...
        <div class="tab-content">
                      ...
                      <br><hr><br>
                      <h3>Chi tiết lương từng tháng</h3>
                      <br><hr><br>
                      <div class="form-inline">
  <label for="example-datetime-local-input" class="col-2 col-md-1 col-form-label">Tháng </label>
  <div class="col-5 col-md-3">
    <input class="form-control"  name="dt1" id="month" value="">
  </div>
  <label for="example-datetime-local-input" class="col-2 col-md-1 col-form-label">Năm </label>
  <div class="col-5 col-md-3">
    <input class="form-control"  name="dt2" id="year" value="">

</div>


  <div class="col-5 col-md-3">
<button class=" form-control " style="background-color: red;color: white" onclick="salaryHistory()">Xem</button>
</div>
</div>
          <div id="content1" class="tab-pane in active">
                ...
                <div class="title-list-proxy"><i class="fa fa-list" aria-hidden="true"></i> &nbsp;</div>
                    ...
                    <div class="proxy-add" title="New Edge"><button  type="button" class=" form-control " style="background-color: red;color: white" ><a href="/icon/finance" ><a href="finance/salary-update"> Cập nhật bảng lương</a></button>
</div>
                  ...
                  <table id="table1" class="nvr-table">
                        ...
                        <tbody class="tbody">
                          @foreach($users_near as $user)
                            ...
                            <td><button style="color: white"  type="button" onclick="showInfo('{{$user->id}}')" class="btn btn-del Disable"><i class="fa fa-eye" aria-hidden="true" style="font-size: 1.2rem;"></i></button>

                            <button style="color: white"  type="button" onclick="updateInfo('{{$user->id}}')" class="btn btn-del Disable"><i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size: 1.2rem;"></i></button>
                          </td>
...
function salaryHistory(){
  ...
  var y = d.getFullYear();
   ...
   window.location.href= "/finance/salary-detail/"+y+"/"+m
  }
}
  $(document).ready(function() {
          if($("#notice_success").val() == 1){
