...
@section('content')
  ...
  <ul class="nav nav-tabs" id="tabs" role="tablist">
      ...
      <li class="nav-item margin_center">
          <a id="tab2" class="nav-link color-a"  data-toggle="tab" role="tab" href="#content2">Giao dịch đang thực hiện</a>
      </li> 
      <li class="nav-item margin_center">
          <a id="tab3" class="nav-link color-a"  data-toggle="tab" role="tab" href="#content3">Giao dịch đã hoàn thành</a>
      </li>
     <li class="nav-item margin_center">
          <a id="tab4" class="nav-link color-a"  data-toggle="tab" role="tab" href="#content4">Giao dịch đã hủy</a>
      </li>
    </ul> 
  <hr>
...
<div class="tab-content">
  <div id="content1" class="tab-pane  in active">
                  ...
                  <table id="zone-table" class="nvr-table">
                        ...
                        <tbody class="tbody">
                          @foreach($myzone as $myzone)
                            <tr class="color-add">
                              
                              <td><i id="project{{$myzone->id}}" class="fa fa-circle active-off cam-status" aria-hidden="true"></i> <img src="js-css/img/icon/map.png" width='32' height='32'><a > {{$myzone->name}}</a></td>

                              <td>{{$myzone->cname}}</td>
                              <td>{{$myzone->phone_number}}</td>
                              <td>{{$myzone->sname}}</td>
                              @if($myzone->state < 2)

                              <td>Đã đặt cọc</td>
                              @elseif($myzone->state == 2)

                              <td>Đang thanh toán</td>


                              @endif
 <td>{{number_format($myzone->gap, 0, ",", ".") }} VND</td>
                              <td>{{number_format($myzone->gap*($myzone->done/$myzone->final_price), 0, ",", ".") }} VND</td>

                              <?php
                              $total_gap = $total_gap + $myzone->gap;
                              $total_real_gap = $total_real_gap + $myzone->gap*($myzone->done/$myzone->final_price);
                              ?>
                      ...
                      <h3>Tổng hoa hồng: {{number_format($total_gap, 0, ",", ".") }} VND</h3>

                      <h3>Đã nhận: {{number_format($total_real_gap, 0, ",", ".") }} VND</h3>
                    </div>
...
<div id="content2" class="tab-pane  in">
                        ...
                        <tbody class="tbody">
                          @foreach($zone as $zone)
                            <tr class="color-add">
    	                        ...
    	                        <td><i id="project{{$zone->id}}" class="fa fa-circle active-off cam-status" aria-hidden="true"></i> <img src="js-css/img/icon/map.png" width='32' height='32'><a > {{$zone->name}}</a></td>
 ...
 <div id="content3" class="tab-pane in">

                  <table id="zone-done-table" class="nvr-table">
                        <thead>
                        <tr class="thead">
                     ...
                     <div id="content4" class="tab-pane in">

                  <table id="zone-del-table" class="nvr-table">
                        <thead>
                        <tr class="thead">
