...
<tr>
                ...
                <td id="acreage"><span id="FinalStatus">
                  <h4 style="color: red">Đã hủy bỏ</h4>
...
function genInnerTasks(objectid, innerList,type,pos){
  html = ""
  html = html +  ' <table id="inner-table"  class="nvr-table "><thead><tr class="thead"><th  style= "width: 40%">Yêu cầu</th><th   class = "center-th" style= "width: 15%" >Ngày ký</th><th   class = "center-th" style= "width: 15%" >Ngày đến hạn</th><th style= "width: 30%" class = "center-th">Minh chứng</th></tr></thead><tbody class="tbody">'
