...
<div class="row">
 ...
 <button onclick="newConsumerBtn()" type="button" class="btn btn-model">Sang nhượng hợp đồng cho khách mới</button>
 -->
  <br><hr><br>
                <div>
                  <tr>
...
<td>  <input value="{{$infomation->cname}}" id="cname1" name="cname1" class="input-edit modol-text" required="">
</td>
</tr>
<tr>
<td > Ngày sinh </td>
...
<td > Số căn cước</td>
<td>
<input value="{{$infomation->identify_card}}" id="cidentify1" name="cidentify1" class="input-edit modol-text" required="">
</td>
</tr>
<tr>
<td > Ngày cấp </td>
<td> <input value="{{$infomation->iden_date}}" type="date" class="input-edit modol-text form-control" name="ciden_date1" id="ciden_date1" required="">
</td>
</tr>
<tr>
<td >Nơi cấp</td>
<td>
<input value="{{$infomation->iden_location}}" id="clocation1" name="clocation1" class="input-edit modol-text" required="">
</td>
</tr>
<tr>
<td >Địa chỉ</td>
<td>
<input value="{{$infomation->address}}" id="caddress1" name="caddress1" class="input-edit modol-text" required="">
</td>
</tr>
</tbody></table>      
<br><hr>
...
{{$consumer2->name}}
@endif
  " name="cname2" id="cname2" class="input-edit modol-text" >
</td>
</tr>
<tr>
<td > Ngày sinh </td>
<td> <input value="
  @if($infomation->married == 2)
{{$consumer2->birth_date}}
@endif
" type="date" class="input-edit modol-text form-control" name="birth_day2" id="birth_day2" >
</td>
</tr>
<tr>
<td >Điện thoại</td>
...
<input value="
@if($infomation->married == 2)
{{$consumer2->phone_number}}
@endif
" id="cphone2" name="cphone2" class="input-edit modol-text">
</td>
</tr>
<tr>
<td >Email: </td>
...
{{$consumer2->email}}
@endif
" id="cemail2" name="cemail2" class="input-edit modol-text" >
</td>
</tr>
...
<input value="
@if($infomation->married == 2)
{{$consumer2->identify_card}}
@endif
" id="cidentify2" name="cidentify2" class="input-edit modol-text">
</td>
</tr>
<tr>
<td > Ngày cấp </td>
...
{{$consumer2->iden_date}}
@endif
" type="date" class="input-edit modol-text form-control" name="ciden_date2" id="ciden_date2" >
</td>
</tr>
<tr>
<td >Nơi cấp</td>
...
<input value="
@if($infomation->married == 2)
{{$consumer2->iden_location}}
@endif
" id="clocation2" name="clocation2" class="input-edit modol-text">
</td>
</tr>
<tr>
<td >Địa chỉ</td>
...
{{$consumer2->address}}
@endif
" id="caddress2" name="caddress2" class="input-edit modol-text" >
</td>
</tr>
</tbody></table>
<br><hr>
