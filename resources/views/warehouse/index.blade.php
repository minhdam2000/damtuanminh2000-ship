...
-->
 ...
 <div class="s013" style="min-height: auto;">
      ...
      <button type="button"  class="btn btn-secondary btn-danger btn-sm" data-toggle="modal" data-target="#new-url">Thêm tệp mới</button>


      <a  class="btn btn-secondary btn-danger btn-sm" target="_blank" href="/tag-group">Quản lý từ đồng nghĩa</a>
...
@if(strlen($pfile->tags) > 0)
      <a  class="btn btn-model" id="allTagBtn" onclick="showTag({{$pfile->id}})">Xem tags</a>
@endif
                          </td>
                         <td>
...
@if(strlen($file->tags) > 0)
      <a  class="btn btn-model" id="allTagBtn" onclick="showTag({{$file->id}})">Xem tags</a>
@endif
...
@if(strlen($form->tags) > 0)
      <a  class="btn btn-model" id="allTagBtn" onclick="showTag({{$form->id}})">Xem tags</a>
  @endif                        </td>
...
<div class="modal fade modol-text" id="show_tag" role="dialog">
          <div class="modal-dialog" style="width: 50%;margin-top: 10%;">
            <!-- Modal content-->
            <div class="modal-content">
              <div class="notification"></div>
             
                  <div id="show_tag_content" class="modal-body">
...
<script type="text/javascript">
  ...
  inp.addEventListener("input", function(e) {
      ...
      /*for each item in the arrayXem tags*/
...
function showTag(id){
    document.getElementById("show_tag_content").innerHTML = document.getElementById("smalltag"+id).innerHTML
    $("#show_tag").modal()
}
