...
<?php
 ...
 <tr class="color-add">
                          ...
                          <td ><a target="_blank" href="/schedule/detail/{{$file->sid}}" >{{$file->title}} (Công việc:{{$file->stitle}} )</a>
...
$old_date_timestamp = strtotime($file->time);
 ...
 @foreach($schedules as $schedule)
                        ...
                        <tr class="color-add">
                          ...
                          <td ><a target="_blank" href="/schedule/detail/{{$schedule->id}}" >{{$schedule->title}} </a>
