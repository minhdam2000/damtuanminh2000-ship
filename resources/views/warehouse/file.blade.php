  ...
  color: #ffffff;
    ...
    <div class="row row-content">
      ...
      <li class="nav-item margin_center">
          ...
          data-toggle="tab" role="tab" href="#content1">Kho dữ liệu dự án {{$project->name}}</a>
      </li>    
    </ul>  
    <hr>

        <div class="tab-content"> <label  class="preview" for="file-input">
          <a href="/warehouse/list" type="button"  class="btn btn-model" > Quay lại</a>
<button type="button" class="btn btn-model" data-toggle="modal" data-target="#new-url">Thêm tệp mới</button>
<a type="button" class="btn btn-model" href="warehouse/data-img/{{$id}}" >Kho dữ liệu hình ảnh</a>
                    ...
                    <tbody class="tbody">
                      @foreach($file as $file)
                        <tr class="color-add">   
                          ...
                          <td><span style="display: none" id="type{{$file->id}}"> {{$file->type}}</span>
                            @if($file->type == 1)
                              Kinh doanh 
                            @elseif($file->type == 2)
                            Xây dựng
                    ...
                    <table class="table-edit table-model">
                        <tbody class="table-edit">
                           ...
                           <tr>
                                ...
                                <td>
                                <select value="" class="custom-select select-profile  browser-default"  data-live-search="true"  name="type" id= "">
                        ...
                        <tbody class="table-edit">
                          ...
                          <tr>
                             ...
                             <tr>
                                <td class="cam-properties">Loại: </td>
                                <td>
                                <select value="" class="custom-select select-profile  browser-default"  data-live-search="true"  name="type" id= "editType">
