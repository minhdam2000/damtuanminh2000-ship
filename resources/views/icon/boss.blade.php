...
<!-- 
        <div class="col-lg-3 col-md-3 col-sm-3  col-3  my-2">
          <a href="/icon/report">
            <div class="mycard"> <img class="card-img-top"src="js-css/img/icon/report.png">
                <div class="card-body">
                            <h7 class="font-weight-bold">Báo cáo tổng hợp</h7>
    ...
    <!--   <div class="col-lg-3 col-md-3 col-sm-3 col-3  my-2">
        ...
        <!--   <div class="col-lg-3 col-md-3 col-sm-3 col-3  my-2">
         ...
         <div class="col-lg-3 col-md-3 col-sm-3 col-3  my-2">
          <a href="/vip/event">
            <div class="mycard"> <img class="card-img-top" src="js-css/img/icon/vip.jpg">
                <div class="card-body">
                            <h7 class="font-weight-bold">VIP</h7>
...
<!--                  <div class="ccol-lg-3 col-md-3 col-sm-3 col-3  my-2 ">
          <a href="/minh/fuzzyt">
            <div class="mycard"> <img class="card-img-top"src="js-css/img/icon/warehouse.png">
                <div class="card-body">
                            <h7 class="font-weight-bold">Lọc Kho dữ liệu</h7>
