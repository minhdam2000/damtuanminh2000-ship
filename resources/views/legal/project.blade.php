    ...
    <div class="content-camera">
        ...
        <div class="">
         ...
         ?>
                        ...
                        <tbody class="tbody">
                          @foreach($projects as $project)
                            <tr class="color-add">
    	                        ...
    	                        <td><i id="project{{$project->id}}" class="fa fa-circle active-off cam-status" aria-hidden="true"></i> <img src="js-css/img/icon/map.png" width='32' height='32'><a href="/legal/data/{{$project->id}}"> {{$project->name}}</a>
          ...
          <button  type="button"  class="btn btn-model"><a href="/icon/legal/" > Quay lại</a></button>
        	</div>
        </div>
    </div>
    <!-- Modal -->
