        ...
        <div class="">
          <div class="row row-content">
            <div class="row-title-proxy">
              <form action="/genstaff/delete-mul-step" method="POST">
                        ...
                        <tbody class="tbody">
                          @foreach($step as $step)
                            <tr class="color-add">
                              ...
                              <td><button style="color: white"  type="button" onclick="updateInfo('{{$step->id}}')" class="btn btn-del Disable"><i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size: 1.2rem;"></i></button>
                              <a style="color: white"  type="button" href="genstaff/step-detail/{{$step->id}}" class="btn btn-del Disable"><i class="fa fa-list" aria-hidden="true" style="font-size: 1.2rem;"></i></a>
                            </td>
                            </tr>
                          @endforeach
                        </tbody>
 ...
 <div class="tab-content modal-body">
      ...
      <div class="modal fade modol-text" id="new-edge" role="dialog">
          <div class="modal-dialog model-right" style="height: auto;min-height: 100%;min-width: 55%">
            ...
            <div class="modal-content">
              <div class="modal-header">
                  <label>Tạo nhiệm vụ mới  </label>
              </div>
              <div class="notification"></div>
              <form action="genstaff/add-new-step" method="POST" enctype="multipart/form-data">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
      ...
      <div class="modal fade modol-text" id="EditInfoModal" role="dialog">
          <div class="modal-dialog model-right" style="height: auto;min-height: 100%;min-width: 55%">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
              <form action="genstaff/edit-step" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
