        ...
        <div class="">
          <div class="row row-content">
            <div class="row-title-proxy">
              <form action="/genstaff/delete-mul-task" method="POST">
                        ...
                        <tbody class="tbody">
                          @foreach($task as $task)
                            <tr class="color-add">
                              ...
                              <td><button style="color: white"  type="button" onclick="updateInfo('{{$task->id}}')" class="btn btn-del Disable"><i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size: 1.2rem;"></i></button>
      ...
      <div class="modal fade modol-text" id="new-edge" role="dialog">
          <div class="modal-dialog model-right">
            ...
            <div class="modal-content">
              ...
              <form action="genstaff/add-new-task" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
      ...
      <div class="modal fade modol-text" id="EditInfoModal" role="dialog">
          <div class="modal-dialog model-right">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
              <form action="genstaff/edit-task" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
