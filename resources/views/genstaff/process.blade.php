        ...
        <div class="">
          <div class="row row-content">
            <div class="row-title-proxy">
              <form action="/genstaff/delete-mul-process" method="POST">
                        ...
                        <tbody class="tbody">
                          @foreach($process as $process)
                            <tr class="color-add">
                              ...
                              <a style="color: white"  type="button" href="genstaff/process-detail/{{$process->id}}" class="btn btn-del Disable"><i class="fa fa-list" aria-hidden="true" style="font-size: 1.2rem;"></i></a>

                               <a style="color: white"  type="button" href="genstaff/process-lock/{{$process->id}}" class="btn btn-del Disable"><i class="fa fa-lock" aria-hidden="true" style="font-size: 1.2rem;"></i></a>
      ...
      <div class="modal fade modol-text" id="new-edge" role="dialog">
          <div class="modal-dialog model-right">
            ...
            <div class="modal-content">
              ...
              <form action="genstaff/add-new-process" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
      ...
      <div class="modal fade modol-text" id="EditInfoModal" role="dialog">
          <div class="modal-dialog model-right">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
              <form action="genstaff/edit-process" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
