        ...
        <div class="">
          <div class="row row-content">
            <div class="row-title-proxy">
              <form action="genstaff/delete-mul-process-step" method="POST">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                <input type="hidden" name="process_id" value="<?=$id?>">
                <div class="title-list-proxy"><i class="fa fa-list" aria-hidden="true"></i> &nbsp;</div>
                   <div class="proxy-add" title="New Edge">
<button type="button" class="camera-button" data-toggle="modal" data-target="#new-step"><i class="fa fa-plus" aria-hidden="true"></i>Thêm nhiệm vụ</button></div>
<div class="proxy-add" title="New Edge">
<button type="button" class="camera-button" data-toggle="modal" data-target="#new-edge"><i class="fa fa-plus" aria-hidden="true"></i>Thêm nhiệm vụ đã có</button></div>
                          ...
                          @foreach($processstep as $info)
                            <tr class="color-add">
                              ...
                              <td><button type="button" onclick="editDetail('{{$info->id}}')" class="btn btn-del Disable"><i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size: 1.2rem; color: white;"></i></button>
                               ...
                               <a style="color: white"  type="button" href="genstaff/step-detail/{{$info->pid}}/{{$info->sid}}" class="btn btn-del Disable"><i class="fa fa-list" aria-hidden="true" style="font-size: 1.2rem;"></i></a>
                             </td>
                            </tr>
                          @endforeach
                        </tbody>
    ...
    <div class="modal fade modol-text" id="new-step" role="dialog">
          <div class="modal-dialog model-right">
            ...
            <div class="modal-content">
              ...
              <form action="genstaff/add-new-process-step2" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
                    ...
                    <table class="table-edit table-model">
                        <tbody class="table-edit">
                              <tr>
                                ...
                                <input type="hidden" name="process_id" value="<?=$id?>">
                                <td>
                                <input class="input-edit modol-text"  name="step"></td></td>
                            </tr>
                           <tr>
      ...
      <div class="modal fade modol-text" id="new-edge" role="dialog">
          <div class="modal-dialog model-right">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
              <form action="genstaff/add-new-process-step" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
                  <div class="modal-body">
                    <table class="table-edit table-model">
                        <tbody class="table-edit">
                              <tr>
                                <td class="cam-properties">Nhiệm vụ</td>
                                <input type="hidden" name="process_id" value="<?=$id?>">
                                <td><select class="custom-select select-profile  browser-default"  data-live-search="true"  name="step" id= "stepselect">
         ...
         <div class="modal fade modol-text" id="EditInfoModal" role="dialog">
          <div class="modal-dialog model-right">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
              <form action="genstaff/edit-process-step" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
