...
@section('content')
    ...
    <hr>
        ...
        <div class="tab-content">
          <form id="uploadfile" action="process/edit-task-file"  enctype="multipart/form-data" method="POST"><input type="hidden" name="_token" value="{{csrf_token()}}">  <label  class="preview" for="file-input">
