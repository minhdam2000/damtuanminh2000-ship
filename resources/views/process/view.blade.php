...
<br>
  ...
  <hr>
<button type="button" class="btn btn-model" data-toggle="modal" data-target="#new-step" onclick="newBigStep()">Thêm bước mới v1</button>
  <div class="tab-content">
...
<!-- <button type="button" class="btn btn-model" data-toggle="modal" data-target="#new-url1" onclick="closeFile()">Thêm tệp mới m2</button> -->
...
$old_date_timestamp = strtotime($form->created_at);
 ...
 ?> </span>
                          ...
                          <td>
                                 ...
                                 <button style="color: white"  type="button" onclick="editInputDetail('{{$form->id}}')" class="btn btn-del Disable preview" > <img src="/js-css/img/icon/notepad.png"> </button>
...
<button type="button" class="btn btn-model" data-toggle="modal" data-target="#new-url2" onclick="closeFile()">Thêm tệp mới 3</button>
...
<span style="display: none" id="testgrouptag">
                          ...
                          ?>
                            ...
                            <span style="display: none"  id="tag{{$form->id}}"> {{$form->tags}}
...
<td>
   <button style="color: white"  type="button" onclick="editAllDetail('{{$form->id}}')" class="btn btn-del Disable preview" > <img src="/js-css/img/icon/edit.png"> </button>
           <a href="legal/file-delete/<?=$form->id?>" type="button"  class="preview" > <img src="/js-css/img/icon/edit.png"> </a>
          ...
          <div class="modal-dialog model-right" style="width: 50%">
            ...
            <div class="modal-content">
             ...
             <input id="newTag" type="text" data-role="tagsinput" name="tags" value="" class="form-control tags">
                           ...
                           <tr>
                <td class="cam-properties">Tệp tin 1 </td>
