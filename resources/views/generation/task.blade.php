    ...
    <div class="content-camera">
        <div class="header-content">
            <div class="header-content-left">
                <h6>Quản lý điều kiện pháp lý</h6>
            </div>
            <div class="header-content-right" style="display: inline;">
                <h6 class="display-inline">Quản lý điều kiện pháp lý<</h6>
            </div>
        </div>
        <div class="session">
        ...
        <div class="">
          <div class="row row-content">
            <div class="row-title-proxy">
              <form action="/gen/delete-mul-task" method="POST">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                <div class="title-list-proxy"><i class="fa fa-list" aria-hidden="true"></i> &nbsp;Danh sách điều kiện pháp lý</div>
                      <div class="proxy-add" title="New Edge"><button type="button" class="camera-button" data-toggle="modal" data-target="#new-edge"><i class="fa fa-plus" aria-hidden="true"></i> Điều kiện mới </button></div>
                  ...
                  <table id="camera-table" class="nvr-table">
                        ...
                        <tbody class="tbody">
                          @foreach($task as $task)
                            <tr class="color-add">
                              <td>
                                <input type="checkbox" id="{{$task->id}}" value="{{$task->id}}" name="{{$task->id}}" class="check-box" />
                                <label for="{{$task->id}}" class="add-cam"></label>
                              </td>
                              <td><div><a> <i class="fa fa-address-card" aria-hidden="true" style="font-size: 1.2rem;"></i><span id="cname{{$task->id}}"> {{$task->name}}</span></a></td>

                              <td><div><a> <i class="fa fa-address-card" aria-hidden="true" style="font-size: 1.2rem;"></i><span id="ctype{{$task->id}}"> {{$task->legal_type}}</span></a></td>

                              <td>

  <a style="color: white" href="/gen/task-detail/{{$task->id}}" class="btn btn-del Disable"><i class="fa fa-list" aria-hidden="true" style="font-size: 1.2rem;"></i></a>

                                <button style="color: white"  type="button" onclick="updateInfo('{{$task->id}}')" class="btn btn-del Disable"><i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size: 1.2rem;"></i></button>
      ...
      <div class="modal fade modol-text" id="new-edge" role="dialog">
          <div class="modal-dialog model-right">
            ...
            <div class="modal-content">
              ...
              <form action="gen/add-new-task" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
                    ...
                    <table class="table-edit table-model">
                        <tbody class="table-edit">
                            ...
                            <tr>
                                ...
                                <td><input type="" value="" name="type" class="input-edit modol-text"required=""></td>
                            </tr>
      ...
      <div class="modal fade modol-text" id="EditInfoModal" role="dialog">
          <div class="modal-dialog model-right">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
              <form action="gen/edit-task" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
                  ...
                  <div class="modal-body">
                    <table class="table-edit table-model">
                        <tbody class="table-edit">
                            ...
                            <tr>
                                <td class="cam-properties">Nơi cấp </td>
                                <td><input type="" value="" name="type" class="input-edit modol-text" id="EditType" required=""></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
...
function updateInfo(id){
          ...
          document.getElementById("EditName").value = document.getElementById("cname"+id)

          document.getElementById("EditType").value = document.getElementById("ctype"+id).innerHTML
        $("#EditInfoModal").modal()
