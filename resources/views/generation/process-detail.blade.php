                        ...
                        <tbody class="tbody">
                          @foreach($processstep as $info)
                            <tr class="color-add">
                              ...
                              <a style="color: white"  type="button" href="gen/step-detail/{{$info->pid}}/{{$info->sid}}" class="btn btn-del Disable"><i class="fa fa-list" aria-hidden="true" style="font-size: 1.2rem;"></i></a>
                              </td>
                            </tr>
                          @endforeach
                        </tbody>
   ...
   <div class="modal fade modol-text" id="new-step" role="dialog">
          <div class="modal-dialog model-right">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
              <form action="gen/add-new-process-step2" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
