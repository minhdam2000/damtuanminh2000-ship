    ...
    <div class="content-camera">
        <div class="header-content">
            ...
            <div class="header-content-right" style="display: inline;">
                ...
                /
                <h6 class="display-inline">  {{ $task->name }}</h6>
            </div>
        </div>
        <div class="session">
        ...
        <div class="tab-content">
          ...
          <div id="content1" class="tab-pane  in active">
              <form action="gen/delete-mul-task-detail" method="POST">
                        ...
                        <tbody class="tbody">
                          @foreach($roles as $role)
                            <tr class="color-add">
                              ...
                              <td><div><a id="tname{{$role->id}}"> {{$role->tname}}</a></td>
      ...
      <div class="modal fade modol-text" id="new-edge" role="dialog">
          <div class="modal-dialog model-right" style="height: auto;min-height: 100%;min-width: 55%">
            ...
            <div class="modal-content">
              ...
              <form action="gen/add-new-task-detail" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
