        ...
        <div class="">
          <div class="row row-content">
            <div class="row-title-proxy">
              <form action="/gen/delete-mul-process" method="POST">
                        ...
                        <tbody class="tbody">
                          @foreach($process as $process)
                            <tr class="color-add">
                              ...
                              <td id="pid{{$process->id}}">{{$process->project_id}}</td>
                              ...
                              <a style="color: white"  type="button" href="gen/process-detail/{{$process->id}}" class="btn btn-del Disable"><i class="fa fa-list" aria-hidden="true" style="font-size: 1.2rem;"></i></a>
                            </td>
                            </tr>
                          @endforeach
                        </tbody>
                  ...
                  <div class="modal-body">
                    <table class="table-edit table-model">
                        <tbody class="table-edit">
                            ...
                            <tr>
                                <td class="cam-properties">PID </td>
                                <td><input type="" value="0" name="pid" class="input-edit modol-text"  required=""></td>
                            </tr>
                  ...
                  <div class="modal-body">
                    <table class="table-edit table-model">
                        <tbody class="table-edit">
                            ...
                            <tr>
                                <td class="cam-properties">PID </td>
                                <td><input type="" value="" name="pid" class="input-edit modol-text" id="EditPid" required=""></td>
                            </tr>
