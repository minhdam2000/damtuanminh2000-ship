  ...
  color: #ffffff;
    ...
    <div class="row row-content">
      ...
      <li class="nav-item margin_center">
          ...
          data-toggle="tab" role="tab" href="#content1">Kho dữ liệu xây dựng cho {{$project->name}}</a>
      </li>    
    </ul>  
    <hr>

        <div class="tab-content"> <label  class="preview" for="file-input">
          <a href="/contribute/list" type="button"  class="btn btn-model" > Quay lại</a>
          ...
          <div class="modal-dialog model-right" style="width: 50%">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
               <form id="uploadfile" action="contribute/edit-task-file"  enctype="multipart/form-data" method="POST">
                <input type="hidden" name="_token" value="{{csrf_token()}}">  
   ...
   <div class="modal fade modol-text" id="new-edge" role="dialog">
          <div class="modal-dialog model-right" style="width: 50%">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
              <form action="contribute/edit-task-file-name" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
                  <div class="modal-body">
                    <table class="table-edit table-model">
                        <tbody class="table-edit">
