                        ...
                        <tbody class="tbody">
                          @foreach($projects as $project)
                            <tr class="color-add">
    	                        ...
    	                        <td><i id="project{{$project->ip}}" class="fa fa-circle active-off cam-status" aria-hidden="true"></i> <img src="js-css/img/icon/map.png" width='32' height='32'><a href="/contribute/data/{{$project->id}}"> {{$project->name}}</a></td>
