  ...
  <div id="content1" class="tab-pane  in active">
          <div class="row row-content">
            <div class="row-title-proxy">
                      <div class="proxy-add" title="New Edge"><button type="button" class=" job-create camera-button" data-toggle="modal" data-target="#create-job" id="0"><i class="fa fa-plus" aria-hidden="true"></i>công việc mới </button></div>
  ...
  <tr class="color-add">
                            ...
                            <td style="width:5%" ><h4 id="index{{$schedule->id}}">{{$i}}</h4></td>
                              ...
                              <?php 
                                $i = $i + 1;
                             ?>
                              <td style="width:50%"><div><h4><a ondblclick="BigLinkFun({{$schedule->id}})" target="_blank"  id="BigLink{{$schedule->id}}" ><i class="fa fa-address-card" aria-hidden="true" style="font-size: 1.2rem;">  </i> <span id="title{{$schedule->id}}">{{$schedule->title}}</span></a></h4></div></td>
