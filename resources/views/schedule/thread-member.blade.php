...
#ShareLink{
    ...
    display: none;
        ...
        <form id="add-thread" method="POST" action="add-thread" 
         enctype="multipart/form-data">

          <input type="hidden" name="_token" value="{{csrf_token()}}">
          <input type="hidden" name="schedule_id" id="schedule_id" value="{{$sid}}">
          ...
          <div  class="modal-dialog model-right"  style="min-width: 100%;height: auto">
            ...
            <div class="modal-content">
              <div class="modal-header">
                  <label  style="font-size: 31px;"> Thêm thành viên vào  cuộc trò chuyện</label>
              </div>
