  ...
  <div id="content1" class="tab-pane  in active">
          ...
          <div class="row row-content">
           ...
           <div  id="root{{$schedule->id}}">
                        ...
                        <thead>
                        <tr class="thead">
                            <th style="width:30%">Tổng quan</th>
