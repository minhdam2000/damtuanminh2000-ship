                          ...
                          @foreach($config as $config)
                            <tr class="color-add">
                              ...
                              <td><div><a> <i class="fa fa-cog" aria-hidden="true" style="font-size: 1.2rem;"></i><span id="cname{{$config->id}}"> {{$config->cname}}</span></a></td>
                                <td><span id="var{{$config->id}}"> {{$config->var}}</span></td>
                                <td><span id="value{{$config->id}}"> {{$config->value}}</span></td>
                                <td><span style="display: none;" id="dept{{$config->id}}"> {{$config->did}}
                                </span>
 {{$config->dname}}
                              </td>
         ...
         <div class="modal fade modol-text" id="edit-edge" role="dialog">
          <div class="modal-dialog model-right" style="height: auto;min-height: 100%;min-width: 55%">
            ...
            <div class="modal-content">
              ...
              <div class="notification"></div>
              <form action="edit-config" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
                    ...
                    <table class="table-edit table-model">
                        <tbody class="table-edit">
                               <td class="cam-properties">Tên: </td>
                                ...
                                <td><input type="" value="" name="name" class="input-edit modol-text"  required="" id="nameInput"></td>
                            </tr>
                            <tr>
                                <td class="cam-properties">Biến: </td>
                                
                                <td><input type="" value="" name="var" class="input-edit modol-text"  required="" id="varInput"></td>
                            </tr>
                            <tr>
                                <td class="cam-properties">Giá trị: </td>
                            ...
                            <td></td>
                                <td><select   name="dept_id" class="custom-select select-profile  browser-default"  data-live-search="true" id="taskselect2">
...
function updateInfo(id){
          ...
          document.getElementById("nameInput").value = document.getElementById("cname"+id).innerHTML
          document.getElementById("varInput").value = document.getElementById("var"+id).innerHTML
          document.getElementById("valueInput").value = document.getElementById("value"+id).innerHTML


          document.getElementById("taskselect2").value = document.getElementById("dept"+id).innerHTML
