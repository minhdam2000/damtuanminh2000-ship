...
@section('content')
        	...
        	<div class="row row-content">
              ...
              <form action="#" method="POST" id="form-camera">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
          			<div class="title-list-proxy"><i class="fa fa-list" aria-hidden="true"></i> &nbsp;Thông tin đặt cọc</div>
  ...
  <ul class="nav nav-tabs" id="tabs" role="tablist">
      <li class="nav-item margin_center">
          <a id="tab1" class="nav-link active color-a"  data-toggle="tab" role="tab" href="#content1">Đang có</a>
      </li> 
      <li class="nav-item margin_center">
          <a id="tab2" class="nav-link color-a"  data-toggle="tab" role="tab" href="#content2">Đã hoàn thành</a>
      </li>
      <li class="nav-item margin_center">
          <a id="tab2" class="nav-link color-a"  data-toggle="tab" role="tab" href="#content3">Đã đóng</a>
      </li>
...
<div id="content1" class="tab-pane  in active">
                  ...
                  <table id="zone-table" class="nvr-table">
                        ...
                        <tbody class="tbody">
                          @foreach($deposit as $deposit)
                            <tr class="color-add">
    	                        ...
    	                        <td><i id="deposit{{$deposit->id}}" class="fa fa-circle active-off cam-status" aria-hidden="true"></i> <img src="js-css/img/icon/map.png" width='32' height='32'><a href="/deposit/view/{{$deposit->id}}"> {{$deposit->name}}</a></td>
                    ...
                    <div id="content2" class="tab-pane  in fade">
                  ...
                  <table id="zone-table" class="nvr-table">
                        ...
                        <tbody class="tbody">
                          @foreach($deposit_complete as $deposit)
                            <tr class="color-add">
                    ...
                    <div id="content3" class="tab-pane  in fade">
                  ...
                  <table id="zone-table" class="nvr-table">
                        ...
                        <tbody class="tbody">
                          @foreach($deposit_close as $deposit)
                            <tr class="color-add">
