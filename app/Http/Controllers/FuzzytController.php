...
class FuzzytController extends Controller
{  
 ...
 public function minh(){
   ...
   $final_data = [];
    ...
    if(count($final_data) > 0){
            // echo "File goc: ".$file_search."<br>";
            // foreach($final_data as $res){

            //     echo "File giong nhau: ".$res."<br>";
            // }
            // echo "<br>-----<br>";
        $row_data[]=$file_search;
        $row_data[]=$final_data;
    ...
    return view('minh.fuzzy',compact('display_data'));  
}
